...
router.get('/', auth(), awaitHandlerFactory(nguoiDungController.getAllNguoiDung)); // localhost:3000/api/v1/users
router.get('/ma_nguoi_dung/:ma_nguoi_dung', auth(), awaitHandlerFactory(nguoiDungController.getNguoiDungById)); // localhost:3000/api/v1/users/id/1
router.get('/ten_dang_nhap/:ten_dang_nhap', auth(), awaitHandlerFactory(nguoiDungController.getNguoiDungByTenDangNhap)); // localhost:3000/api/v1/users/usersname/julia
